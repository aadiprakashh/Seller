      ...
      {productList.map((product, index) => (
        <div className="product-list" key={index}>
          ...
          <div className="d-flex  justify-content-between">
            <div class="card pricing-card pricing-inventory col-md-4">
              ...
              <div class="card-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-6 text-end final-price">
                    ₹ {product.finalPrice}
                  </div>
                </div>
                <div class="row mb-2">
                  ...
                  <div class="col-6 text-end">{product.stock} units</div>
                </div>
                <div class="row mb-2">
                  <div class="col-6">
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-6 text-end">₹ {product.totalRevenue}</div>
                </div>
              </div>
              <div class="card-footer d-flex justify-content-between action-buttons pt-3">
                <a href="#" class="btn edit-btn btn-sm">
                  Edit Price
                </a>
                <a href="#" class="btn manage-btn btn-sm">
                  Manage Stock
                </a>
              </div>
            </div>
            ...
            <section className="card shipping-fulfillment col-md-4">
              ...
              <div class="card-body">
                <div class="row mb-2">
                  ...
                  <div class="col-6 text-end">{product.shippingOptions}</div>
                </div>
                <div class="row mb-2">
                  <div class="col-6">
                    <strong>Handling time:</strong>
                  </div>
                  <div class="col-6 text-end"> {product.handlingTime}</div>
                </div>
              </div>
              <div class="card-footer d-flex justify-content-between action-buttons pt-3">
                <a href="#" class="btn edit-btn btn-sm">
